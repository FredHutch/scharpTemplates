...
* For pagebreaks use the `visc_clearpage()` funtion. You can use this as a simple inline code: `` `r knitr::inline_expr("visc_clearpage()")` ``.
...
* The table name will be chunk name plus "tab:".
    + For example, if chunk name is "descriptive-stats" then the table label will be "tab:descriptvie-stats"
