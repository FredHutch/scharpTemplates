...
if (gitremote == "") {
  ...
  all_git_files <- system('git ls-tree -r --name-only --full-tree master', intern = TRUE)
  ...
  if(length(folder_info_in)==0){
    ...
    folder_info_in <- ifelse(folder_info_in == "vignettes", "inst/doc", folder_info_in)
    }
...
print(xtab, include.rownames = FALSE, size = "\\footnotesize")
```
