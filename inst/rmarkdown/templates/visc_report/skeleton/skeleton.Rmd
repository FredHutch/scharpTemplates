...
Describe in detail the plots included in the report (response rate, response magnitude, magnitude breadth, etc.). Describe the axe as well as any faceting, coloring, and shapes used. Make sure to describe any aspects of plots that apply to a subset of data (significant test p-values, boxplots of responders only, etc.).
