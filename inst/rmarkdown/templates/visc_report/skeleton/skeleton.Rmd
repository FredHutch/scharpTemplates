...
Describe response call criteria and response magnitude measures of interest (including truncation, if applicable). Describe magnitude breadth analysis, if included in the report. This section is often taken from the SAP, but be sure to use past tense.
...
Describe the tests used for statistical analyses in the report (Fisher's exact, Wilcoxon rank-sum, etc.). Make sure to include testing critera (responders only, at least 3 responders, truncation, etc.). Be sure to describe any p-value adjustment done.
