...
\fancypagestyle{firstpage}{%
  \lhead{\includegraphics[height=0.8cm]{./logos/scharp.png}}
  \chead{\includegraphics[height=0.8cm]{./logos/new_VISC_logo_color.jpg}}
  \rhead{\includegraphics[height=0.8cm]{./logos/FredHutch_h_tag_4col_CMYK_tm.png}}
}
