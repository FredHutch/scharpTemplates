...
\usepackage{hyperref}
\usepackage{caption}
\DeclareCaptionType{supptable}[Supplementary Table][List of Supplementary Tables]
\newenvironment{supptab}{\captionsetup{type=supptable}}{}
\DeclareCaptionType{suppfigure}[Supplementary Figure][List of Supplementary Figures]
\newenvironment{suppfig}{\captionsetup{type=suppfigure}}{}
\usepackage{url}
\usepackage{float}
...
$if(endfloat)$
\usepackage[$endfloat.opts$]{endfloat}
$endif$
