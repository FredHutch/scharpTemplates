...
\fancyhead[L]{\includegraphics[height=0.8cm]{./scharp.png}}
\fancyhead[C]{\includegraphics[height=0.8cm]{./new_VISC_logo_color.jpg}}
\fancyhead[R]{\includegraphics[height=0.8cm]{./FredHutch_h_tag_4col_CMYK_tm.png}}
...
{\bf RE:} \> Statistical Analysis Plan for $studyname$ \\
...
\newpage
\fancyhead[R]{\em $studyname$}
\fancyhead[L]{\em VISC Statistical Analysis Plan}
